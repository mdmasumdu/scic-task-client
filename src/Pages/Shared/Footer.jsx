...
const Footer = () => {
    return (
        <footer className="footer items-center  bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% p-4 bg-neutral text-neutral-content">
